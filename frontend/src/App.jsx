...
function AnomalyTicker({ items }) {
  ...
  return (
    <div style={{
      background: T.redDim, border: `1px solid ${T.red}30`, borderRadius: 8,
...
export default function App() {
  ...
  const sendChat = async () => {
    ...
    try {
      ...
      setChat(c => [...c, { role: "ai", text: `Error: ${err.message}. Is the backend running?` }]);
    }
    setChatBusy(false);
  };
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 40, position: "relative", zIndex: 5 }}>
        <div style={{ maxWidth: 620, width: "100%" }}>
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <h1 style={{
              fontSize: 50, fontWeight: 900, letterSpacing: "-0.04em", lineHeight: 1.05,
          ...
          <div
            style={{
              border: `2px dashed ${dragOver ? T.cyan : T.border}`, borderRadius: 20,
            ...
            {["🤖 ARIA AI Advisor", "📈 6-Month Forecast", "🌱 CO₂ Impact",
              "⚙ CLI + Terraform", "⚠ Risk Detection", "🏛 Multi-Cloud"].map(f => (
                <span key={f} style={{
                  ...
                  padding: "5px 13px", borderRadius: 20, fontSize: 12, color: T.muted
                }}>{f}</span>
              ))}
          </div>
        </div>
  ...
  if (phase === "scanning") return (
    <Shell center>
      ...
      <div style={{ textAlign: "center", position: "relative", zIndex: 5 }}>
        <div style={{
          width: 76, height: 76, borderRadius: 18, margin: "0 auto 22px",
          background: `linear-gradient(135deg,${T.cyan}30,${T.blue}30)`,
          border: `2px solid ${T.cyan}60`, display: "flex", alignItems: "center",
          justifyContent: "center", fontSize: 34, animation: "spin-slow 3s linear infinite"
        }}>☁</div>
      ...
      <div style={{ flex: 1, padding: "26px 24px", maxWidth: 1440, margin: "0 auto", width: "100%" }}>
                  ...
                  <thead>
                    <tr>
                      {["", "ID", "Provider", "Type", "Region", "CPU", "Mem", "Storage", "Cost/Mo", "Risk", "Savings"].map(h => (
                        <th key={h} style={{
                          textAlign: "left", padding: "9px 11px", color: T.muted,
                          fontWeight: 700, fontSize: 10, borderBottom: `1px solid ${T.border}`,
                          letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: T.mono, whiteSpace: "nowrap"
                        }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                          ...
                          <td style={{ padding: "10px 11px" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                              <div style={{ width: 36, height: 3, background: T.border, borderRadius: 2 }}>
                                <div style={{
                                  width: `${r.cpu_avg}%`, height: "100%", borderRadius: 2,
                              ...
                              <div style={{
                                ...
                                <div style={{ display: "flex", gap: 10, marginBottom: 12, alignItems: "center" }}>
                                  ...
                                  <button onClick={e => { e.stopPropagation(); setTfOpen(tfOpen === i ? null : i); }}
                                    style={{
                                      background: tfOpen === i ? T.purpleDim : T.card, border: `1px solid ${T.border}`,
                                ...
                                {(tfOpen === i ? r.terraformFix : r.cliCmds).map((cmd, k) => (
                                  <div key={k} style={{
                                    fontFamily: T.mono, fontSize: 11, color: tfOpen === i ? T.purple : T.green,
                                    ...
                                    <button onClick={e => { e.stopPropagation(); copyText(cmd, `${i}-${k}`); }}
                                      style={{
                                        background: copied === `${i}-${k}` ? T.greenDim : T.cyanDim,
        ...
        {tab === "recommendations" && (
          <div>
            ...
            {/* Summary banner */}
            <div style={{
              background: T.card, border: `1px solid ${T.green}30`, borderRadius: 14,
              ...
              <div style={{ marginLeft: "auto" }}>
                ...
                <div style={{ width: 180, height: 7, background: T.border, borderRadius: 4 }}>
                  <div style={{
                    width: `${savingsPct}%`, height: "100%", borderRadius: 4,
                ...
                <div key={i} style={{
                  ...
                  <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: 12 }}>
                    <div style={{
                      ...
                      letterSpacing: "0.08em", marginBottom: 8, fontFamily: T.mono
                    }}>Action Items</div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 7, marginBottom: 12 }}>
                      {r.actions.map((a, j) => (
                        <div key={j} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                          ...
                          <span style={{
                            background: a.impact === "High" ? T.redDim : a.impact === "Medium" ? T.amberDim : T.greenDim,
                    ...
                    {r.cliCmds.length > 0 && (
                      <details style={{ marginTop: 4 }}>
                        <summary style={{
                          cursor: "pointer", fontSize: 12, color: T.cyan,
                ...
                <thead>
                  <tr>
                    {["Month", "Projected", "Optimised", "Savings", "Reduction"].map(h => (
                      <th key={h} style={{
                        textAlign: "left", padding: "9px 13px", color: T.muted,
                        fontWeight: 700, fontSize: 10, borderBottom: `1px solid ${T.border}`,
        ...
        {tab === "advisor" && (
          <div style={{ display: "flex", gap: 18, height: "calc(100vh - 200px)", minHeight: 520 }}>
                ...
                <div style={{
                  ...
                  {chat.map((m, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{
                        background: m.role === "user" ? T.blueDim : T.subtle,
                  ...
                  {chatBusy && (
                    <div style={{ display: "flex", gap: 10 }}>
                      <div style={{
                        width: 32, height: 32, borderRadius: 9, background: T.cyanDim,
                        border: `1px solid ${T.cyan}40`, display: "flex", alignItems: "center", justifyContent: "center"
                      }}>✦</div>
                      <div style={{
                        background: T.subtle, border: `1px solid ${T.border}`,
                ...
                <div style={{ borderTop: `1px solid ${T.border}`, padding: 14 }}>
                  <div style={{ display: "flex", gap: 9 }}>
                    <input value={chatIn} onChange={e => setChatIn(e.target.value)}
                      ...
                      style={{
                        flex: 1, background: T.subtle, border: `1px solid ${T.border}`,
                    ...
                    <button onClick={sendChat} disabled={chatBusy || !chatIn.trim()}
                      style={{
                        background: chatBusy || !chatIn.trim() ? T.subtle
            ...
            <div style={{ width: 240, display: "flex", flexDirection: "column", gap: 8, paddingTop: 52 }}>
              <div style={{
                fontSize: 9, fontWeight: 800, color: T.muted, textTransform: "uppercase",
                letterSpacing: "0.1em", fontFamily: T.mono, marginBottom: 4
              }}>QUICK PROMPTS</div>
              {[
...
const NavBar = ({ children }) => (
  <nav style={{
    borderBottom: `1px solid ${T.border}`, padding: "0 36px", height: 58,
...
const Pill = ({ color, children }) => (
  <span style={{
    background: `${color}15`, color, border: `1px solid ${color}30`,
    padding: "4px 12px", borderRadius: 20, fontSize: 11, fontWeight: 800, fontFamily: T.mono
  }}>{children}</span>
);
const Orb = ({ style }) => (
...
const CmdBlock = ({ cmd, color, copyKey, copied, onCopy }) => (
  <div style={{
    fontFamily: T.mono, fontSize: 11, color,
    ...
    <button onClick={() => onCopy(cmd, copyKey)}
      style={{
        background: copied === copyKey ? T.greenDim : T.cyanDim,
